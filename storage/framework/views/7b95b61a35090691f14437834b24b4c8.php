...
<head>
    ...
    <title><?php echo e($title ?? 'MakersMarkt'); ?></title>
    <style>
        :root {
            --bg: #f4f7fb;
            --paper: #ffffff;
...
<body>
    <header class="topbar">
        <div class="container topbar-inner">
            <a href="<?php echo e(route('home')); ?>" class="brand">MakersMarkt</a>
            <nav class="nav">
                <a href="<?php echo e(route('home')); ?>" class="<?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">Home</a>
                <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('products.index')); ?>" class="<?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>">Producten</a>
                <a href="<?php echo e(route('makers.index')); ?>" class="<?php echo e(request()->routeIs('makers.*') ? 'active' : ''); ?>">Makers</a>
                <a href="<?php echo e(route('orders.index')); ?>" class="<?php echo e(request()->routeIs('orders.*') ? 'active' : ''); ?>">Bestellingen</a>
                <a href="<?php echo e(route('dashboard')); ?>" class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">Dashboard</a>
                <?php if(auth()->user()->isAdminOrModerator()): ?>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') || request()->routeIs('statistics.*') ? 'active' : ''); ?>">Admin Dashboard</a>
                <?php endif; ?>
                ...
                <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="<?php echo e(request()->routeIs('login') ? 'active' : ''); ?>">Inloggen</a>
                <a href="<?php echo e(route('register')); ?>" class="<?php echo e(request()->routeIs('register') ? 'active' : ''); ?>">Registreren</a>
                <?php endif; ?>
            </nav>
        </div>
    </header>
...
</html><?php /**PATH C:\Users\daalm\DrinkOrDare\DrinkOrDare\MakersMarkt\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>